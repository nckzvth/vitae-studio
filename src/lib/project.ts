...
// Browser font rasterization can differ by a fraction of a pixel per line.
// Keep a small protected band above the configured bottom margin so those
// fractions can never accumulate into clipped export content.
const PAGE_FLOW_SAFETY_PX = 12;
